...
for index in xrange(numTriangulationCells):
	...
	previous_point_identifier = coordinates_to_point[previous_point]
	current_point_identifier = coordinates_to_point[current_point]
	...
	if ((isoband in lower_intolerable_indices) or (isoband in upper_intolerable_indices)):
		...
		print 'The face', triangle_points_to_triangle_index[cell_points], 'is not part of the segmentation', isoband
	else:
		print simplex_scalar, previous_scalar, current_scalar
		print 'The face', triangle_points_to_triangle_index[cell_points], 'is part of the segmentation', isoband
...
for i in range(1209473, 1209473 + 5):
	print point_index_to_link_triangles[i]

save_object(sorted_nodes, 'sorted_nodes')
save_object(arcs, 'arcs')
save_object(point_scalars, 'point_scalars')
save_object(point_index_to_link_triangles, 'point_index_to_link_triangles')
save_object(triangle_index_to_points, 'triangle_index_to_points')
